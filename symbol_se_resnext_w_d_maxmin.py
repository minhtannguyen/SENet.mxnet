...
def residual_unit(data, datamin, num_filter, ratio, stride, dim_match, name, num_group, bottle_neck=True,  bn_mom=0.9, workspace=256, memonger=False):
    ...
    if bottle_neck:
        ...
        conv_weight1 = mx.sym.Variable(name=name +'_conv_weight_wb1', init=mx.init.Xavier(rnd_type='gaussian', factor_type="in", magnitude=2))
        ...
        conv_weight2 = mx.sym.Variable(name=name +'_conv_weight_wb2', init=mx.init.Xavier(rnd_type='gaussian', factor_type="in", magnitude=2))
        ...
        conv_weight3 = mx.sym.Variable(name=name +'_conv_weight_wb3', init=mx.init.Xavier(rnd_type='gaussian', factor_type="in", magnitude=2))
        ...
        fc_weight1 = mx.sym.Variable(name=name +'_fc_weight_wb1', init=mx.init.Xavier(rnd_type='gaussian', factor_type="in", magnitude=2))
        fc_bias1 = mx.sym.Variable(name=name +'_fc_bias_wb1', init=mx.init.Zero())
        ...
        fc_weight2 = mx.sym.Variable(name=name +'_fc_weight_wb2', init=mx.init.Xavier(rnd_type='gaussian', factor_type="in", magnitude=2))
        fc_bias2 = mx.sym.Variable(name=name +'_fc_bias_wb2', init=mx.init.Zero())
        ...
        excitation = mx.sym.Activation(data=excitation, act_type='relu', name=name + '_excitation2_relu')
        excitationmin = -mx.sym.Activation(data=-excitationmin, act_type='relu', name=name + '_excitation2_relumin')
        ...
        if dim_match:
            ...
            shortcut_weight1 = mx.sym.Variable(name=name + '_shortcut_weight_wb1', init=mx.init.Xavier(rnd_type='gaussian', factor_type="in", magnitude=2))
...
def resnext(units, num_stage, filter_list, ratio_list, num_class, num_group, data_type, drop_out, bottle_neck=True, bn_mom=0.9, workspace=256, memonger=False):
    ...
    fc_weight_sf = mx.sym.Variable(name='fc_weight_sf', init=mx.init.Xavier(rnd_type='gaussian', factor_type="in", magnitude=2))
    fc_bias_sf = mx.sym.Variable(name='fc_bias_sf', init=mx.init.Zero())
